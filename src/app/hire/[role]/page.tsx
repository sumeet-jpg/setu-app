...
const ROLE_MAP: Record<string, {
  ...
  'ai-marketing-manager': {
    ...
    description: 'An AI Marketing Manager that plans campaigns, manages budgets, and delivers weekly reports — $49/mo. Interview free before you hire.',
  ...
  'whatsapp-sales-bot': {
    ...
    description: 'An AI WhatsApp Sales Agent that qualifies leads, answers product questions, and books appointments 24/7 — $49/mo. Interview free.',
  ...
  'ai-cfo': {
    ...
    h1: 'Hire an AI CFO',
    description: 'An AI CFO that manages cash flow, board-level reporting, and financial strategy — without the ₹25L salary. $49/mo.',
    keyword: 'AI CFO',
  ...
  'ai-customer-support': {
    ...
    description: 'An AI Customer Support Agent that resolves 80% of tickets automatically on WhatsApp — without a support team. $49/mo.',
  ...
  'ai-cmo': {
    ...
    h1: 'Hire an AI CMO',
    description: 'An AI Chief Marketing Officer that sets strategy, manages your brand, and runs specialist agents — at a fraction of a CMO salary. $49/mo.',
    keyword: 'AI CMO',
  ...
  'ai-coo': {
    ...
    h1: 'Hire an AI COO',
    description: 'An AI Chief Operating Officer that manages operations, vendor relations, and execution cadence — commanding a full agent fleet. $49/mo.',
    keyword: 'AI COO',
  ...
  'ai-sales-manager': {
    ...
    description: 'An AI Sales Manager that runs your pipeline, manages accounts, and drives revenue — without the commission overhead. $49/mo.',
  ...
  'ai-hr-manager': {
    ...
    description: 'An AI HR Manager that handles onboarding, compliance, payroll coordination, and employee queries — $49/mo.',
  ...
  'whatsapp-ecommerce-bot': {
    ...
    description: 'An AI WhatsApp Commerce Agent that runs your product catalogue, order confirmations, and cart recovery on WhatsApp — $49/mo.',
  ...
  'ai-financial-analyst': {
    ...
    description: 'An AI Financial Analyst that builds board-ready models, cash flow forecasts, and scenario analyses — on demand. $49/mo.',
